...
return [
    ...
    */
    ...
    'payumoney' => [                         // PayUMoney Parameters
        'merchantKey'  => env('INDIPAY_MERCHANT_KEY', 'uWq3IWpo'),
        'salt'  => env('INDIPAY_SALT', 'rKawV2ZolS'),
        'workingKey' => env('INDIPAY_WORKING_KEY', ''),

        // Should be route address for url() function
        'successUrl' => env('INDIPAY_SUCCESS_URL', 'PaymentSuccess'),
        'failureUrl' => env('INDIPAY_FAILURE_URL', 'PaymentFailed'),
    ],
